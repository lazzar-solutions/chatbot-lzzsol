(function () {
  ...
  chatbotButton.innerHTML = `<img src="${icon}" alt="Chatbot Icon" style="width:60px; height:60px;">`;
  ...
  chatWindow.style.backgroundImage =
    "radial-gradient(circle, lightgray 1px, transparent 1px)";
  chatWindow.style.backgroundSize = "10px 10px";
  ...
  chatForm.addEventListener("submit", async (event) => {
    ...
    botMessageElement.innerHTML = `<div style="background-color: #f1f1f1; color: black; padding: 10px; border-radius: 10px; margin: 5px 0; max-width: 70%; font-size: 75%; opacity: 0; transform: translateY(20px); transition: all 0.3s ease;">${botMessage}</div>`;
